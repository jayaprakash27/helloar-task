...
const MainContainer = () => {
  ...
  return (
    <div className=' flex relative z-0 w-full flex-col'>
        ...
        { isaddSong && <AddSongForm className=' absolute z-100' /> }
        ...
        { songs.map(song => (
            <div className=' w-full p-2 grid items-center grid-cols-5'>
                ...
                <div >
                <svg onClick={ e => setCurrSong(song.id) } className=' hover:opacity-70 cursor-pointer' width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
