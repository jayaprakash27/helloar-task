...
function Login() {
  ...
  return (
    <div className="login-page">
      <div className=" login-box flex flex-col w-80 gap-2 justify-center">
        ...
        />
        <button onClick={handleLogin} className=" w-full rounded-lg p-3 hover:bg-purple-600  bg-primary-color text-white"> Sign In </button>
      </div>
      <div className=" login-box flex flex-col w-80 gap-2 justify-center">
        <h1 className=" text-primary-color font-semibold">OTP Verification</h1>
        <p className=" text-sm">
        We have sent and OTP to +{phoneNumber}. Please enter the code received to verify.
        </p>
        <PhoneInput
          country={"in"}
          enableSearch={true}
