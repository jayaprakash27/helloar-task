...
function Login() {
  ...
  const handleVerifyOTP = () => {
    // Define the URL of the "Verify OTP" API
    const apiEndpoint = 'https://dev.api.goongoonalo.com/auth/verify_otp'; // Replace with the actual API endpoint URL

    // Create the request payload
    const requestBody = {
      phoneNumber: phoneNumber, // Use the 'phoneNumber' state or passed as a prop from the previous page
      requestId: requestId, // Use the 'requestId' state or passed as a prop from the previous page
      otp: otp.join(""),
    };
